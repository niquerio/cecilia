...
RSpec.describe "GET /api/teachers/:username" do
  it "returns user info" do
    ...
    activity = create(:activity, event_id: event.id, difficulty: Difficulty.find_by(level: 3), activity_type: ActivityType.first, activity_subtype: ActivitySubtype.first)
